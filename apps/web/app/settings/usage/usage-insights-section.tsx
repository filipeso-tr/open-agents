...
function InsightMetric({
  ...
  return (
    <div className="min-w-0 rounded-xl border border-border/50 bg-muted/20 p-4">
      ...
      <div className="mt-1 break-words font-mono text-2xl font-bold tabular-nums tracking-tight sm:text-3xl">
        {value}
      </div>
      {detail ? (
                ...
                {insights.topRepositories.map((repo) => (
                  ...
                  >
                    <div className="flex flex-col gap-1 min-[480px]:flex-row min-[480px]:items-baseline min-[480px]:justify-between">
                      ...
                      <span className="shrink-0 font-mono text-xs tabular-nums text-muted-foreground min-[480px]:text-right">
